...
import ExerciseInputFooter from "./ExerciseInputFooter.tsx";
          ...
          <DividerSpaced
            ...
            center={
              <div className="reps-goal">
                <div className="reps-goal-number">{currentExercise.reps[workoutState.currentSetIndex]}</div>
            ...
            right={
              <div className="navigation-button-container">
                <button
                  ...
                  onClick={handleNext}
                >
                  {weightInput === 0 ? <LuArrowRight size={24} /> : <LuCheck size={24} />}
                </button>
