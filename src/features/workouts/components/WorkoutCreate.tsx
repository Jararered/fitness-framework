        ...
        content={
          <span className="card-row">
            ...
            <button
              className="right"
              onClick={() => {
                const randomWorkout = generateRandomWorkout(selectedMuscleGroup as MuscleGroup, selectedEquipment);
                      ...
                      <span className="exercise-preview-item">
                        ...
                        <div className="exercise-details">
                          ...
                          <div className="exercise-reps">
                            {exercise.reps.length > 0 ? `${exercise.reps.join(", ")} Reps` : "No reps selected"}
                          </div>
                        </div>
                        <span className="exercise-edit-buttons">
                          ...
                          <button
                            className="exercise-delete-button icon caution"
                            onClick={() => handleDeleteExerciseFromCircuit(circuitIndex, exerciseIndex)}
                          >
                            <LuTrash />
                          </button>
                        </span>
